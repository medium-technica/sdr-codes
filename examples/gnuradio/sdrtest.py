...
class sdrtest(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_short*1, '/home/abraham/github/medium-technica/sdr-codes/include/wbfm_raw_iq_2.4M_100k.iq', False, 0, 0)
