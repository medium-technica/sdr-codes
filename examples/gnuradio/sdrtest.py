...
class sdrtest(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.quad_rate = quad_rate = 250e3
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_short*1, '/home/abraham/github/medium-technica/sdr-codes/include/wbfm_raw_iq_250k_25k', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.audio_sink_0 = audio.sink(int(samp_rate), '', True)
        self.analog_wfm_rcv_0 = analog.wfm_rcv(
        	quad_rate=quad_rate,
        	audio_decimation=int(quad_rate/samp_rate),
        )
